...
('1234567890123456', 'Amit', 'Kumar', '9876543210', '2017-01-05', '{"account_number":"1234567890534647","ifsc_code":"1456239875487890","branch_name":"Bangalore"}'),
('2345678901234567', 'John', 'Doe', '8765432109', '2018-02-15', '{"account_number":"2345678900534647","ifsc_code":"2345678905487890","branch_name":"New York"}'),
('3456789012345678', 'Max', 'Verstappen', '7654321098', '2019-03-25', '{"account_number":"3456789010534647","ifsc_code":"3456789015487890","branch_name":"Los Angeles"}'),
('4567890123456789', 'Kora', 'Massey', '6543210987', '2020-04-10', '{"account_number":"4567890120534647","ifsc_code":"4567890125487890","branch_name":"Chicago"}'),
('5678901234567890', 'Emily', 'Brown', '5432109876', '2021-05-20', '{"account_number":"5678901230534647","ifsc_code":"5678901235487890","branch_name":"Houston"}'),
('6789012345678901', 'Bryson', 'Greene', '4321098765', '2022-06-30', '{"account_number":"6789012340534647","ifsc_code":"6789012345487890","branch_name":"San Francisco"}'),
('7890123456789012', 'Briana', 'Kirk', '3210987654', '2018-02-15', '{"account_number":"7890123450534647","ifsc_code":"7890123455487890","branch_name":"New York"}'),
('8901234567890123', 'Daniel', 'Wilson', '2109876543', '2019-03-25', '{"account_number":"8901234560534647","ifsc_code":"8901234565487890","branch_name":"Los Angeles"}'),
('9012345678901234', 'Olivia', 'Anderson', '1234567890', '2020-04-10', '{"account_number":"9012345670534647","ifsc_code":"9012345675487890","branch_name":"Chicago"}'),
('0123456789012345', 'Sophia', 'Taylor', '2345678901', '2021-05-20','{"account_number":"0123456780534647","ifsc_code":"0123456785487890","branch_name":"Houston"}');
...
SELECT * from GOODS;
INSERT INTO Route (starting_station, ending_station, start_time, estimated_travel_time, route_distance)
VALUES 
  ('IITGN Campus', 'Ahmedabad Railway Station', '17:00:00', '1h30m', 10),
  ('Kudasan', 'IITGN Campus', '21:00:00', '30m', 5),
  ('IITGN Campus', 'Gandhinagar Bus Stand', '16:30:00', '45m', 8),
  ('Visat Circle', 'IITGN Campus', '20:00:00', '45m', 7),
  ('IITGN Campus', 'Ahmedabad Airport', '18:00:00', '1h', 9),
  ('IITGN Campus', 'Kudasan', '20:00:00', '30m', 5),
  ('IITGN Campus', 'Sargasan', '19:00:00', '40m', 6),
  ('Sargasan', 'IITGN Campus', '22:00:00', '40m', 6),
  ('IITGN Campus', 'Visat Circle', '19:45:00', '45m', 7);
...
INSERT INTO booking(license_plate_number, email_id) VALUES
('RJ07MN0245','studentA@iitgn.ac.in'),
('RJ07MN0245','studentB@iitgn.ac.in'),
('RJ07MN0245','studentD@iitgn.ac.in'),
('RJ07MN0245','studentE@iitgn.ac.in'),
('RJ07MN0245','studentC@iitgn.ac.in'),
('RJ07MN0245','studentF@iitgn.ac.in'),
('RJ07MN0245','studentG@iitgn.ac.in'),
('GJ09QT6969', 'studentH@iitgn.ac.in'),
('GJ09QT6969', 'studentI@iitgn.ac.in'),
('GJ09QT6969','studentJ@iitgn.ac.in');
...
INSERT INTO Users (username, password, data_, user_img) VALUES
('Amit', MD5('Amit@123'), '{"first_name": "Amit", "last_name": "Kumar", "driver_license_number": "1234567890123456"}', load_file("D:\Books & Assignments 3rdYear\Sem6\DBMS\Assignment2\icons8-male-user-material-rounded\icons8-male-user-96.png")),
('John', MD5('John@123'), '{"first_name": "John", "last_name": "Doe", "driver_license_number": "2345678901234567"}', load_file("D:\Books & Assignments 3rdYear\Sem6\DBMS\Assignment2\icons8-male-user-material-rounded\icons8-male-user-96.png")),
('Alice', MD5('Alice@123'), '{"first_name": "Max", "last_name": "Verstappen", "driver_license_number": "3456789012345678"}', load_file("D:\Books & Assignments 3rdYear\Sem6\DBMS\Assignment2\icons8-male-user-material-rounded\icons8-male-user-96.png")),
('Michael', MD5('Michael@123'), '{"first_name": "Kora", "last_name": "Massey", "driver_license_number": "4567890123456789"}', load_file("D:\Books & Assignments 3rdYear\Sem6\DBMS\Assignment2\icons8-male-user-material-rounded\icons8-male-user-96.png")),
('Emily', MD5('Emily@123'), '{"first_name": "Emily", "last_name": "Brown", "driver_license_number": "5678901234567890"}', load_file("D:\Books & Assignments 3rdYear\Sem6\DBMS\Assignment2\icons8-male-user-material-rounded\icons8-male-user-96.png")),
('David', MD5('David@123'), '{"first_name": "Bryson", "last_name": "Greene", "driver_license_number": "6789012345678901"}', load_file("D:\Books & Assignments 3rdYear\Sem6\DBMS\Assignment2\icons8-male-user-material-rounded\icons8-male-user-96.png")),
('Jessica', MD5('Jessica@123'), '{"first_name": "Briana", "last_name": "Kirk", "driver_license_number": "7890123456789012"}', load_file("D:\Books & Assignments 3rdYear\Sem6\DBMS\Assignment2\icons8-male-user-material-rounded\icons8-male-user-96.png")),
('Daniel', MD5('Daniel@123'), '{"first_name": "Daniel", "last_name": "Wilson", "driver_license_number": "8901234567890123"}', load_file("D:\Books & Assignments 3rdYear\Sem6\DBMS\Assignment2\icons8-male-user-material-rounded\icons8-male-user-96.png")),
('Olivia', MD5('Olivia@123'), '{"first_name": "Olivia", "last_name": "Anderson", "driver_license_number": "9012345678901234"}', load_file("D:\Books & Assignments 3rdYear\Sem6\DBMS\Assignment2\icons8-male-user-material-rounded\icons8-male-user-96.png")),
('Sophia', MD5('Sophia@123'), '{"first_name": "Sophia", "last_name": "Taylor", "driver_license_number": "0123456789012345"}', load_file("D:\Books & Assignments 3rdYear\Sem6\DBMS\Assignment2\icons8-male-user-material-rounded\icons8-male-user-96.png"));
...
-- After adding index on username in the Users table
SELECT username from Users;

-- To find number of drivers in our DB
...
-- Number of drivers in our DB

SELECT COUNT(*) AS TotalTrips
FROM TransportationLog
WHERE starting_station = 'IITGN Campus' AND ending_station = 'Ahmedabad Airport';

SELECT AVG(route_distance) AS AverageDistance
FROM Route;

ALTER TABLE  DrivenBy RENAME TO VehicleAssociations;

----- TABLE EXTENSIONS ----

CREATE TABLE BusSchedule AS (
SELECT starting_station, ending_station, start_time, estimated_travel_time FROM Route WHERE starting_station in ('IITGN Campus','Kudasan','Visat Circle','Sargasan') AND
ending_station in ('IITGN Campus','Kudasan','Visat Circle','Sargasan'));

SELECT * FROM BusSchedule;

-- ------------------------------------------------------------ SET COMPARISON ----------------------------------------------------------------------------
-- query to find the license_plate_number of the vehicles driven by drivers whose date of joining is before 2019-03-25
SELECT license_plate_number
FROM Drivenby
WHERE driver_license_number IN (
    SELECT driver_license_number
    FROM Driver
    WHERE date_of_joining < '2019-03-25'
);

-- find the vehicles allocated to a parking whose capacity is not equal to ALL of the given numbers
SELECT license_plate_number FROM AllocatedParking
WHERE location IN (
    SELECT location
    FROM Parking_Space
    WHERE capacity <> ALL (SELECT capacity FROM Parking_Space WHERE capacity = 50)
);




-- Code for commit/rollback (Edited by Vedant)
START Transaction;

UPDATE Driver SET first_name = "Brian" where driver_license_number = "4567890123456789";

COMMIT; -- If we want to commit the changes, implyingn that they are finalized and there are no errors. Makes changes permanent.

ROLLBACK; -- If there are errors or if you want to discard the changes made in this transaction. Rollback the transaction to undo the changes

SELECT * from Driver;


-- Rename Operation -- Vedant 
-- Goods Table renaming function
ALTER TABLE Goods
CHANGE COLUMN from_ origin varchar(20);

ALTER TABLE  DrivenBy RENAME TO VehicleAssociations; -- Table renaming (if necessary)


--Query for aggregate functions. Did two aggregate functions, if required put more.

-- Total number of trips from IITGN Campus to Ahmedabad Airport
SELECT COUNT(*) AS TotalTrips
FROM TransportationLog
WHERE starting_station = 'IITGN Campus' AND ending_station = 'Ahmedabad Airport';
